...
pot{butler}.table(murderer)=0.64;
pot{butler}.table(notmurderer)=0.36;

pot{maid}=array;
pot{maid}.variables=maid;
pot{maid}.table(murderer)=0.04;
pot{maid}.table(notmurderer)=0.96;
...
pot{knife}.table(notused, murderer,    murderer)   =0.0;
